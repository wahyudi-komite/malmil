...
- [x] Webhook signature verification (SHA512 order_id + status_code + gross_amount + server_key)
...
- [x] Deployment: Nginx config, PM2 cluster mode, Cloudflare SSL, DB backup cron, CI/CD pipeline
